...
<html lang="en">
  ...
  <body class="mb-5 mb-sm-0">
    ...
    <div class="row" style="margin: 0;margin-top: 5.4em;">
      ...
      <aside class="col-12 col-sm-4 col-md-4 col-lg-3 white-text py-3 d-none d-sm-block" style="position: fixed;">
        <ul class="col-12 mx-auto mb-0" id="barraLateralDerecha" style="list-style: none;">
          <li class="mb-3">
            <a class="link-user text-white align-items-center" tabindex="1" href="#"><i class="fas fa-2x mr-2 fa-home" aria-hidden="true"></i><strong>Inicio</strong></a>
          </li>
          <li class="mb-3">
      ...
      <div id="twits" class="col-12 col-sm-8 col-md-8 col-lg-6 py-3 px-3 mb-4 mb-sm-0 ml-auto mr-lg-auto"></div>
    ...
    <!--VENTANA MODAL PARA ACTUALIZAR EL CONTENIDO DE UN TWEET-->
          ...
          <div class="modal-body text-black" style="background-color:#15202B;">
            <div class="form-row">
              <div class="col-12 mb-3">
                ...
                <textarea id="textoTwitEditar" class="control form-control" required="" maxlength="280" placeholder="¿Qué deseas publicar ahora?"></textarea>
                <div class="invalid-feedback">El contenido no debe estar vacío ni exceder los 280 caracteres.</div>
              </div>
            </div>
